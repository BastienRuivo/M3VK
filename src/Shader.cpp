...
Shader::Shader(const VkDevice& device)
{
    ...
    std::vector<char> vertex = M3VKHelper::ReadFile("build/shaders/helloTriangle.vert.spv");
    std::vector<char> fragment = M3VKHelper::ReadFile("build/shaders/helloTriangle.frag.spv");
