    ...
    _cullingModule(_shaderLibrary, _descriptorAllocator)
{
    ...
    meshRegistry.RegisterInstance(MaterialType::Opaque, instance);
    AssetImporter::LoadAsset(_descriptorAllocator, "data/BistroExterior.m3vkasset", meshRegistry, materialRegistry, graphicsCommandPool, graphicsComputeQueue, _samplerLinear.Internal());
